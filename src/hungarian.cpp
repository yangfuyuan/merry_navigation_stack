...
std::string hungarian_print_matrix(int** C, int rows, int cols) {
  int i,j;
  std::stringstream ss;
  ss << std::endl;
  for(i=0; i<rows; i++) {
...
std::string hungarian_print_assignment(hungarian_problem_t* p) {
  return hungarian_print_matrix(p->assignment, p->num_rows, p->num_cols) ;
}

std::string hungarian_print_costmatrix(hungarian_problem_t* p) {
  return hungarian_print_matrix(p->cost, p->num_rows, p->num_cols) ;
}

std::string hungarian_print_status(hungarian_problem_t* p) {
  
  fprintf(stderr,"cost:\n");
  return hungarian_print_costmatrix(p);

  fprintf(stderr,"assignment:\n");
  return hungarian_print_assignment(p);
